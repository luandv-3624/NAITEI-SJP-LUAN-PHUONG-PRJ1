...
import { BookingHistoryDetailSkeleton } from '@/features/booking';
import { useGetBookingDetail } from '@/features/booking';
import { AxiosError, Booking } from '@/types';
import { HTTP_STATUS_CODE } from '@/constants';
import { useTranslation } from 'react-i18next';
import { useParams } from 'react-router';

interface BookingDetailLayoutProps {
  DetailComponent: React.ComponentType<{ booking: Booking }>;
}
...
export function BookingDetailLayout({
  ...
  return <DetailComponent booking={booking} />;
}
